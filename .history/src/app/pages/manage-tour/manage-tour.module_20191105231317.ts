...
@NgModule({
    ...
    declarations: [ManageTourComponent, EditTourComponent, AddTourComponent, DetailComponent, DeleteComponent, ListTouristComponent],
    entryComponents: [ManageTourComponent, EditTourComponent, AddTourComponent, DetailComponent, DeleteComponent, ListTouristComponent],
})
