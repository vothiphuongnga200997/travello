...
export class ManageTourComponent implements OnInit {
    ...
    delete(event) {
        this.dialogConfig = {
            ...
            content: `Do you want to delete guide ${event.data.code}?`,
            data: event.data,
            rightBtnLabel: 'OK',
            leftBtnLabel: 'Cancel',
    ...
    async onDelete(event) {
        ...
        try {
            ...
            if (result) {
                this.toastrService.success(`Delete guide ${event.data.code} success`, `Delete guide`);
                this.getTour();
            } else {
                this.toastrService.error(`Delete guide ${event.data.code} fail`, `Delete guide`);
            }
        } catch (error) {
