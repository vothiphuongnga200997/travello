...
export class AddTourComponent implements OnInit {
    ...
    arrayListGuide: any = {}; // mang luu guide theo thu tu thoi diem cap 2
    ...
    protected onSelectedGuide(item: CompleterItem, i) {
        ...
        if (item) {
            this.arrayListGuide[this.formPrivate.value.listSchedule[i].startDay] = {
                id: item.originalObject.id,
                fullname: item.originalObject.fullname,
            };
        }
        (this.arrayListGuide1[i] = this.arrayListGuide[this.formPrivate.value.listSchedule[i].startDay]), console.log(this.arrayListGuide);
    }
