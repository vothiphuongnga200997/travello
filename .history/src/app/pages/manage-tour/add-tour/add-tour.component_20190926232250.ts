...
export class AddTourComponent implements OnInit {
    ...
    ngOnInit() {
        if (this.obj) {
            ...
            (this.nameTour = this.obj.get('nameTour')),
                (this.duration = this.obj.get('duration')),
                (this.hotel = this.obj.get('hotel')),
                (this.childrenPrice = this.obj.get('childrenPrice')),
                (this.adultPrice = this.obj.get('adultPrice')),
                (this.departure = this.obj.get('departure'));
        }
