...
export class AddTourComponent implements OnInit {
    ...
    async ngOnInit() {
        ...
        if (this.obj) {
            ...
            this.queryLocaton = await this.tourService.getLocation(this.obj.res);
            for (let i = 0; i < this.queryLocaton.length; i++) {
                this.listLocations.push({
                    id: this.queryLocaton[i].id,
                    location: this.queryLocaton[i].get('location'),
                });
    ...
    onSubmit() {
        ...
        console.log(this.queryLocaton);
        for (let l of this.queryLocaton) this.tourService.deleteGuide(this.obj.res.id, l);
        this.submitted = true;
