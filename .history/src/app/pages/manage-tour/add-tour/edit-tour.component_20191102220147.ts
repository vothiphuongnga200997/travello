...
export class EditTourComponent implements OnInit {
    ...
    async editSchedule(i) {
        ...
        try {
            ...
            this.guideFirst[this.numberFormSchedule] = this.arrayListGuide[this.numberFormSchedule].slice();
    ...
    async submitSchedule() {
        ...
        let edit = this.tourService.editSchedule(this.formPrivate.value, this.arrayListGuide, this.guideFirst);
        this.contactList1.clear();
        this.getForm();
    }
