...
export class EditTourComponent implements OnInit {
    ...
    async submitSchedule() {
        ...
        let edit = this.tourService.editSchedule(this.formPrivate.value, this.arrayListGuide, this.guideFirst, this.code);
        if (edit) {
            this.loadingService.start();
