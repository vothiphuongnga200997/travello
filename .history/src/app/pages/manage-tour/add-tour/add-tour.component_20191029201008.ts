...
export class AddTourComponent implements OnInit {
    ...
    public listSchedule: FormArray;
    public listGuideSchedule: FormArray;
    listGuide: Array<any> = [];
    title: string;
    ...
    get contactFormGroup1() {
        return this.formPrivate.get('schedule') as FormArray;
    }
    constructor(
    ...
    async ngOnInit() {
        ...
        this.listSchedule = this.formPrivate.get('schedule') as FormArray;
        ...
        try {
            this.listSchedule.push(
                this.formBuilder.group({
                    startDay: [null, Validators.compose([Validators.required])],
                    endDay: [null, Validators.compose([Validators.required])],
                    guide: [null, Validators.compose([Validators.required])],
                    hotel: [null, Validators.compose([Validators.required])],
                }),
            );
            this.listGuideSchedule = this.formPrivate.get('guide') as FormArray;
        } catch (ex) {
            console.log(ex);
        }
    }
