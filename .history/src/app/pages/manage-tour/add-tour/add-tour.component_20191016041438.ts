...
export class AddTourComponent implements OnInit {
    ...
    async ngOnInit() {
        ...
        if (this.obj) {
            ...
            this.guideFirst = this.listGuide;
            ...
            this.locationFirst = this.listLocations;
    ...
    async onSubmit() {
        ...
        if (this.obj) {
            ...
            for (let g of this.guideFirst) await this.tourService.deleteGuide(this.obj.res.id, g);
            for (let l of this.locationFirst) await this.tourService.deleteLocation(this.obj.res.id, l);
        }
