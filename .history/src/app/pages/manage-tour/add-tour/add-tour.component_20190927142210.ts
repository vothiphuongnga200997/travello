import { NgModule, ElementRef, ViewChild, AfterViewInit, ChangeDetectorRef } from '@angular/core';
...
export class AddTourComponent implements OnInit, AfterViewInit {
    ...
    async ngOnInit() {
        ...
        if (this.obj) {
            ...
            this.guide[0] = '4HWJ0qOXKo';
            // this.commonSelectedItem[2] = 'javascript';
    ...
    ngAfterViewInit() {
        if (this.obj) {
            let g = this.tourService.getGuide(this.obj.res);
    ...
    async getGuide() {
        ...
        console.log(this.getGuides);
        console.log(this.downloadMenu);
    }
