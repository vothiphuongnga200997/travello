...
export class CostComponent implements OnInit {
    ...
    constructor(private formBuilder: FormBuilder, protected ref: NbDialogRef<CostComponent>, private loadingService: LoadingService) {}
    ngOnInit() {
        this.getCost();
    ...
    async submit() {
        ...
        this.submitted = true;
        console.log(this.formPrivate.value);
        if (this.formPrivate.invalid && this.formPrivate.value.listSchedule === []) {
            return;
        }
