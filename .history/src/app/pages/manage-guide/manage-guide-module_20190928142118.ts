...
import { StatsCardBackComponent } from './task-guide/tour-pending';
...
@NgModule({
    ...
    declarations: [ManageGuideComponent, ButtonViewComponent, AddGuideComponent, TaskGuideComponent, StatsCardBackComponent],
