...
import { TaskGuideComponent, ButtonTaskComponent } from './task-guide/task-guide.component';
...
@NgModule({
    ...
    declarations: [ManageGuideComponent, ButtonViewComponent, AddGuideComponent, TaskGuideComponent, ButtonTaskComponent],
    entryComponents: [ManageGuideComponent, ButtonViewComponent, AddGuideComponent, TaskGuideComponent, ButtonTaskComponent],
})
