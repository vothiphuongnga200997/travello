...
export class ButtonTaskComponent implements ViewCell, OnInit {
    renderValue: string;
...
export class TaskGuideComponent implements OnInit {
    ...
    settings = {
        ...
        columns: {
            ...
            itinerary: {
                title: 'Chi tiết',
                type: 'custom',
                renderComponent: ButtonTaskComponent,
                onComponentInitFunction: instance => {
                    instance.save.subscribe(row => {
                        this.openFilter(row.id);
                    });
                },
                filter: false,
            },
    ...
    constructor(public guideService: GuideService, private windowService: NbWindowService) {}
