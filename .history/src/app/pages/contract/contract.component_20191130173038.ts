...
export class ContractComponent implements OnInit {
    ...
    async getContract() {
        ...
        if (result) {
            for (let surcharge of result.get('surcharge')) {
            ...
            for (let data of result) {
                ...
                sumMoney = data.get('price');
                if (data.get('objSchedule').get('startDay') < dateNow) {
                ...
                this.contract.push({
                    ...
                    pay:
                        'Tổng tiền: ' +
                        this.formatNumber(sumMoney) +
                        ' Đã trả:' +
                        this.formatNumber(data.get('paid')) +
                        ' Còn lại' +
                        this.formatNumber(sumMoney - data.get('paid')),
