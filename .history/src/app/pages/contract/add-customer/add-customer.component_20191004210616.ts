...
export class AddCustomerComponent implements OnInit {
    ...
    ngOnInit() {
        this.form = this.fb.group({
            representative: ['hhhh', Validators.compose([Validators.required])],
    ...
    infoUser(event) {
        if (event) {
            this.form.value.representative = event.originalObject.fullname;
            this.form.value.phone = event.originalObject.phone;
            this.form.value.email = event.originalObject.email;
        }
    }
    // form
    async getTour() {
