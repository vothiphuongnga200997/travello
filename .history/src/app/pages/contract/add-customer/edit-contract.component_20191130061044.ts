...
export class EditContractComponent implements OnInit {
    ...
    async ngOnInit() {
        ...
        let resultCustome = await query.first();
        if (resultCustome) {
            this.paidOfCustomer = resultCustome.attributes.paid - this.priceOld;
            this.idCustomer = resultCustome.id;
            this.discount = resultCustome.attributes.discount;
        ...
        this.price = result.attributes.price + this.priceSurcharge - result.attributes.price * this.discount;
    }
    ...
    async submit(conten1) {
        ...
        if (this.form1.invalid) {
            ...
            await this.pay();
            this.modalService.dismissAll(conten1);
            this.ref.close({
                id: this.idEdit,
