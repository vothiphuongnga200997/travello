...
export class AddCustomerComponent implements OnInit {
    ...
    createContact(): FormGroup {
        if (this.objCustomEdit) {
            for (let i = 0; i <= this.objCustomEdit.length; i++) {
                try {
                    this.fb.group({
                        name: [this.objCustomEdit[1].name],
                        phonecustomer: [this.objCustomEdit[0].phonecustomer],
                        address: [this.objCustomEdit[0].address],
                        gender: [this.objCustomEdit[0].gender],
                    });
                } catch (ex) {
                    console.log(ex);
                }
