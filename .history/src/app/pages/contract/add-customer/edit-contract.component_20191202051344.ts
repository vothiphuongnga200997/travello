...
export class EditContractComponent implements OnInit {
    ...
    async ngOnInit() {
        ...
        if (result) {
            ...
            this.priceTicket = result.attributes.price;
            this.form1 = this.fb.group({
        ...
        if (resultCustomer) {
            ...
            this.discount = resultCustomer.attributes.discount;
    ...
    addTicket() {
        if (this.empty > this.numberAdult + this.addAdult + this.addKids + this.numberKids) {
            ...
            this.priceTicket += this.addAdult * this.priceSA + this.addKids * this.priceSC;
            this.price +=
                this.addAdult * this.priceSA +
                this.addKids * this.priceSC -
                (this.addAdult * this.priceSA + this.addKids * this.priceSC) * this.discount;
