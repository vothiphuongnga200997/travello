...
export class DeleteComponent implements OnInit {
    ...
    async delete() {
        let startDate = moment('24/11/2019', 'DD/MM/YYYY');
        let begin = moment(startDate, 'DD/MM/YYYY');
        let currenDate = moment(new Date()).format('DD/MM/YYYY');
        let endDate = moment(currenDate, 'DD/MM/YYYY');
        let result = 'Diff: ' + endDate.diff(startDate, 'days');
        console.log(result);

        // let currentDay = moment(Date()).format('MM/DD/YYYY');
        // let startDay = moment(this.startDay).format('MM/DD/YYYY');
...
export class DeleteTicketComponent implements OnInit {
    ...
    async delete() {
        let currentDay = moment(Date()).format('DD/MM/YYYY');
        let secon = moment(currentDay);
        // let startDay = moment(this.startDay).format('MM/DD/YYYY');
        let firstDate = moment(this.startDay);
        let diffInDays = moment.duration(firstDate.diff(secon)).asDays();
        console.log(diffInDays);
        // if (diffInDays < 7) {
