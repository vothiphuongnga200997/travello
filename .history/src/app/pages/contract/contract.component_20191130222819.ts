...
@Component({
    ...
    template: `
        <div style="width:180px">
            <p class="mb-1">Tổng tiền: {{ this.value[0].sumMoney | number }}</p>
            <p class="mb-1">Đã thanh toán: {{ this.value[0].paid }}</p>
            <p class="mb-1">Còn lại: {{ this.value[0].unpaid }}</p>
            <p class="mb-1" *ngIf="this.date" class="text-danger">{{ this.date }}</p>
        </div>
    `,
})
