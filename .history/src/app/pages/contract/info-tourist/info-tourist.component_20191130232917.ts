    ...
    async getInfo() {
        ...
        try {
            ...
            if (result) {
                ...
                queryUser.equalTo('objectId', result.attributes.objUser.id);
                try {
    ...
    async getUser() {
        ...
        try {
            ...
            if (result) {
                const customer = Parse.Object.extend('customer');
                const queryCustomer = new Parse.Query(customer);
                queryCustomer.equalTo('objUser', result);
                let resultCustome = await queryCustomer.first();
                console.log('22' + resultCustome);
                this.user.push({
