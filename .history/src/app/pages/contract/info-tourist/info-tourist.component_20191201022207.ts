                ...
                try {
                    ...
                    if (resultUser) {
                        ...
                        this.user.push({
                            ...
                            member: i,
                            idSchedule: result.get('objSchedule').codeSchedule,
                            startDay: moment(result.get('startDay')).format('DD/MM/YYYY, h:mm A'),
                            endDay: moment(result.get('endDay')).format('DD/MM/YYYY, h:mm A'),
                        });
                    }
                } catch (ex) {
                    throw ex;
