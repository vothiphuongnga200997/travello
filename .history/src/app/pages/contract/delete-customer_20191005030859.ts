    ...
    template: `
        <nb-card>
            ...
            <nb-card-body>
                ...
                <div class="footer">
                    <button class="float-right btn btn-info" hero medium>OK</button>
                    <button class="float-right btn  mr-2 ml-0" (click)="dismiss()" nbButton hero medium status="primary">Cancel</button>
                </div>
            </nb-card-body>
        </nb-card>
    `,
