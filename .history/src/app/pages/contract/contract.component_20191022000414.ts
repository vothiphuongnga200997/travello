...
export class ContractComponent implements OnInit {
    ...
    deleteTicket(idUser, idTour, name, phone, numberContract, numberTourist, startDay) {
        this.deleteArray = [];
        // this.deleteArray = this.contract[numberContract].tourist;
        this.deleteArray = this.contract[numberContract].tourist.splice(numberTourist, 1);
        this.dialogService
