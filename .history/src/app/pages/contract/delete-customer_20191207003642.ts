    ...
    async delete() {
        ...
        if (diffInDays < 7) {
            ...
            try {
                ...
                dataSave.sumFare = result.attributes.sumFare - dataSave.price - dataSave.price * result.attributes.discount;
                let save = await obj.save(dataSave);
                if (save) {
                    ...
                    dataCustomer.paid = this.paidOfCustomer + dataSave.price - price - price * this.discount;
                    dataCustomer.discount = 0;
