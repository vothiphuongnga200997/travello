...
@NgModule({
    ...
    declarations: [ContractComponent, AddCustomerComponent, DeleteComponent, EditContractComponent, DeleteTicketComponent],
    entryComponents: [ContractComponent, AddCustomerComponent, DeleteComponent, EditContractComponent, DeleteTicketComponent],
})
