...
@Component({
    ...
    template: `
        <nb-select style="width: 100%" name="platForm" placeholder="Chọn khu vực">
            <nb-option for="let i = 2019 ; i < =2090; i ++" value="Miền Bắc">Miền Bắc</nb-option>
            <nb-option value="Miền Trung">Miền Trung</nb-option>
            <nb-option value="Miền Nam">Miền Nam</nb-option>
        </nb-select>
