...
@NgModule({
    ...
    declarations: [ManageLocationComponent, ButtonViewComponent, AddLocationComponent],
    entryComponents: [ManageLocationComponent, ButtonViewComponent, AddLocationComponent],
})
