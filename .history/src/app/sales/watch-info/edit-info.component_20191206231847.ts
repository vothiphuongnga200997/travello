            ...
            for (let i of this.objCustomEdit) {
                try {
                    this.contactList.push(
                        this.fb.group({
                            name: [i.name, Validators.compose([Validators.required])],
                            phonecustomer: [i.phonecustomer, Validators.compose([Validators.required, Validators.pattern('[0-9]+')])],
                            address: [i.address, Validators.compose([Validators.required])],
                            gender: [i.gender, Validators.compose([Validators.required])],
                            type: [i.type, Validators.compose([Validators.required])],
                        }),
                    );
                } catch (ex) {
                    console.log(ex);
