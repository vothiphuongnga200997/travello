...
@NgModule({
    ...
    declarations: [WatchInfoComponent, ChangeInfoComponent, EditInfoComponent, Paypal, InfoTicket, DeleteTicketComponent, DeleteComponent],
    entryComponents: [EditInfoComponent, Paypal, InfoTicket, DeleteTicketComponent, DeleteComponent],
})
