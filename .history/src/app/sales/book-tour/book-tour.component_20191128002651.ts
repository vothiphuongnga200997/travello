...
export class BookTourComponent implements OnInit {
    ...
    finish: string = 'nga send mail thanh cong  '; // send mail thanh cong
    ...
    surcharge: Array<any> = [];
    confirmation: string;
    inputConfirmation: boolean = false;
    ...
    async onThirdSubmit() {
        if (this.thirdForm.value.confirmation === this.confirmation) {
            console.log(this.thirdForm.invalid);
            this.inputConfirmation = true;
