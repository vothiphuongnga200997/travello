...
export class BookTourComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.firstForm = this.fb.group({
            ...
            surcharge: this.fb.array([this.createSurcharge()]),
    ...
    async onFourSubmit() {
        if (!this.fourForm.value.thirdCtrl && this.fourForm.invalid) {
            return;
        } else {
    ...
    async getTour() {
        ...
        if (result) {
            ...
            this.surcharge = result.get('objTour').attributes.surcharge;
            this.contactList.push(this.fb.group({
                type: [null],
                price: [null],
                quantity: [null],
            }));
