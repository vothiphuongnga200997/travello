...
export class BookTourComponent implements OnInit, AfterViewChecked {
    ...
    ngOnInit() {
        ...
        this.thirdForm = this.fb.group({
            thirdCtrl: [0, Validators.required],
        });
    }
    ...
    async onThirdSubmit() {
        ...
        let result = await this.contractService.booktour(this.firstForm.value, this.secondForm.value, this.totalMoney, this.price);
        console.log(result);
        this.thirdForm.value.thirdCtrl = result;
