...
export class DetailComponent implements OnInit {
    ...
    async getTour(id) {
        this.infoTour = [];
        this.location = [];
        let result = await this.tourService.queryTour(this.id);
        if (result) {
            ...
            await this.infoTour.push({
                ...
                adultPrice: result.attributes.adultPrice - result.attributes.saleoff,
        ...
        this.sale = this.infoTour[0].saleofff;
    }
