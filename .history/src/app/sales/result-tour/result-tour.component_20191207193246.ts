...
export class ResultTourComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.subscribeGetSearchParams = this.activeRoute.queryParams.subscribe(async params => {
            ...
            if (
                !this.dataSearchFromHomeComponet.locationthis ||
                this.dataSearchFromHomeComponet.location !== '' ||
                this.dataSearchFromHomeComponet.location !== undefined
            ) {
            ...
            if (this.dataSearchFromHomeComponet.money !== '' || this.dataSearchFromHomeComponet.money !== undefined) {
