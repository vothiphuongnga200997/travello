export const DEFAULT_THEME = {
    ...
    variables: {
        // Safari fix
        temperature: ['rgb(27, 77, 128)', 'rgb(27, 77, 128)', 'rgb(27, 77, 128)', 'rgb(27, 77, 128)', 'rgb(27, 77, 128)'],

        solar: {
            gradientLeft: 'rgb(27, 77, 128)',
            gradientRight: 'rgb(27, 77, 128)',
        ...
        traffic: {
            ...
            itemEmphasisBorderColor: 'rgb(27, 77, 128)',
        ...
        electricity: {
            ...
            itemBorderColor: 'rgb(27, 77, 128)',
            lineStyle: 'solid',
            lineWidth: '4',
            lineGradFrom: 'rgb(27, 77, 128)',
            lineGradTo: 'rgb(27, 77, 128)',
        ...
        profitBarAnimationEchart: {
            ...
            firstAnimationBarColor: 'rgb(27, 77, 128)',
        ...
        countryOrders: {
            ...
            hoveredCountryBorderColor: '#4ca6ff',
            ...
            chartGradientTo: 'rgb(27, 77, 128)',
            chartGradientFrom: 'rgb(27, 77, 128)',
        ...
        orderProfitLegend: {
            firstItem: 'linear-gradient(90deg, rgb(27, 77, 128) 0%, #3bddad 100%)',
        ...
        visitorsLegend: {
            firstIcon: 'linear-gradient(90deg, rgb(27, 77, 128) 0%, #3bddad 100%)',
