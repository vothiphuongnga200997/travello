...
import { LetterBoldPipe } from './services/letter-bold.pipe';
...
@NgModule({
    ...
    declarations: [LoadingComponent, LetterBoldPipe, SearchFilterPipe, ClickOutsideDirective],
...
export class SharedModule {
    static forRoot(): ModuleWithProviders {
        return {
            ...
            providers: [ParseService, AuthGuard, AuthService, LoadingService, ShareDataService, ToastrService],
        };
    }
}
