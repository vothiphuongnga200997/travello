...
export class ContractService {
    ...
    async getScheduleAdd() {
        ...
        query.greaterThan('startDay', Date.now());
        query.descending('startDay');
        query.equalTo('status', true);
        query.equanlTo('empty', 0);
    ...
    async addContract(data) {
        ...
        dataSave.surcharge = data.info.listSurcharge;
        ...
        console.log(dataSave.expiryDate);
        // try {
        //     // đã có user
        //     if (data.info.idUser !== '') {
        ...
        //                 if (data.paidOfCuctomer + data.sumMoney < 100000000 || data.paidOfCuctomer + data.price >= 50000000)
