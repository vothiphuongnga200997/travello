...
export class ContractService {
    ...
    sendSms(data) {
        this.http.get(
            'http://rest.esms.vn/MainService.svc/json/SendMultipleMessage_V4_get?Phone=09xxxx&Content=DemoText&ApiKey=xxxx&SecretKey=xxxx&Brandname=QCAO_ONLINE&SmsType=2',
        );
    }
