...
export class TourService {
    ...
    async addTour(data) {
        ...
        dataSave.departure = data.value.departure.toCapitalize();
        ...
        dataSave.special = data.value.special();
        dataSave.saleoff = data.value.contacts();
        if (data)
            if (data.guide) {
    ...
    async editTour(data) {
        ...
        dataSave.code = data.code.toUpperCase();
