...
export class ContractService {
    ...
    async getSchedule() {
        ...
        query.select('codeSchedule', 'startDay', 'endDay', 'objTour', 'empty');
        try {
    ...
    async booktour(firstForm: any, secondForm: any, thirdForm: any, totalPrice: number, price: number, quantity: number) {
        let contract = Parse.Object.extend('contract');
        let obj = new contract();
        let dataSave: any = {};
        let dataUser: any = {};
    ...
    sendSms(data) {
        this.http.get(
            'http://rest.esms.vn/MainService.svc/json/SendMultipleMessage_V4_get?Phone=0358660577&Content=DemoText&ApiKey=E7D43D49A9743AEEC0E711291C42B0&SecretKey=F8E099D1D0BF9865A11578696BBC04&Brandname=QCAO_ONLINE&SmsType=2',
        );
    }
