...
import { QlyKhachHangComponent } from './qly-khach-hang.component';
...
@NgModule({
    ...
    exports: [QlyKhachHangComponent],
    declarations: [QlyKhachHangComponent],
})
export class QlyKhachHangtModule {}
